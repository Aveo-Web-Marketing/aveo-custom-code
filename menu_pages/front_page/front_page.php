    ...
    foreach ($snippets as $snippet) {
        ...
        $table_row_html .= '
            <tr class="aveo-single-snippet" data-snippet_type="'. $snippet->type .'" data-snippet_id="' . $snippet->id . '">
                ...
                <td class="snippet_sync_td">' . ($snippet->github_synced == 1 ? '<span class="dashicons dashicons-yes"></span>' : '<span class="dashicons dashicons-no"></span> <span class="try_sync_btn" data-snippet_id="' . $snippet->id . '">Try sync</span>') . '<span class="loader" style="display: none;"></span></td>
            </tr>
        ';
    }
